...
simulates the load on demand behavior nicely.
    ...
    fake_autoload :Speaker, "./speaker.rb"
    p defined?(Speaker)
    Speaker.say("Hello World")
    p defined?(Speaker)
...
We could have a bin/ruby_say.rb that looks like the code below.
